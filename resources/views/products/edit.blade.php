        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex justify-between items-center mb-6">
                <div>
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Perbarui informasi produk</p>
                </div>
                    ...
                    <form method="POST" action="{{ route('products.update', $product) }}" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name', $product->name)" required autofocus placeholder="Enter product name" />
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea id="description" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" name="description" rows="3" placeholder="Enter product description">{{ old('description', $product->description) }}</textarea>
                            ...
                            <div>
                                ...
                                <x-text-input id="sku" class="block mt-1 w-full" type="text" name="sku" :value="old('sku', $product->sku)" required placeholder="Enter SKU" />
                            ...
                            <div>
                                ...
                                <x-text-input id="category" class="block mt-1 w-full" type="text" name="category" :value="old('category', $product->category)" placeholder="Enter category" />
                            ...
                            <div>
                                ...
                                <div class="relative mt-1">
                                    ...
                                    <x-text-input id="price" class="block w-full pl-12" type="number" name="price" :value="old('price', $product->price)" step="0.01" required placeholder="0" />
                                </div>
                            ...
                            <div>
                                ...
                                <x-text-input id="min_stock_level" class="block mt-1 w-full" type="number" name="min_stock_level" :value="old('min_stock_level', $product->min_stock_level ?? 10)" placeholder="10" />
                            ...
                            <div class="flex items-end">
                                <label class="inline-flex items-center">
                                    <input type="checkbox" name="is_raw_material" value="1" {{ old('is_raw_material', $product->is_raw_material) ? 'checked' : '' }}
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="mt-1 flex items-center gap-4">
                                    @if($product->image)
                                        <div class="relative">
                                            <img src="{{ asset('storage/' . $product->image) }}" alt="{{ $product->name }}" class="h-32 w-32 object-cover rounded-lg border border-gray-300 dark:border-gray-600">
                                            <a href="{{ route('products.remove-image', $product) }}" class="absolute -top-2 -right-2 bg-red-500 text-white rounded-full p-1 hover:bg-red-600" title="Remove image">
